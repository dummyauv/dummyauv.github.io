                ...
                <Row className="d-flex justify-content-center">
                    ...
                    <h2 className="text-center mb-4 heading-main">Key Features</h2>
                        <ul classname>
                            ...
                            <li><h4 className="text-left desc-ssk1">Camera, IMU, DVL, Pressure Sensor and Hydrophones on board</h4></li>
                            ...
                            <li><h4 className="text-left desc-ssk1">Production cost of Rs. <b >23,00,000</b></h4></li>
                        </ul>
                    </Col>
                </Row>
                </Container>
