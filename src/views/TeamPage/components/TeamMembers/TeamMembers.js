                            ...
                            <CardBody>
                                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                                    <div className="author">
                                        <p>
                                            Remove this para and add real ayush pic. Present in assets
                                            team folder
                                        </p>
                        ...
                        <Card className="card-profile card-plain">
                            ...
                            <CardBody>
                                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                                    <div className="author">
                                        <p>
                                            Remove this para and add real inshu pic. Present in assets
                                            team folder
                                        </p>
                        ...
                        <Card className="card-profile card-plain">
                            ...
                            <CardBody>
                                <a href="#pablo" onClick={(e) => e.preventDefault()}>
                                    <div className="author">
                                        <p>
                                            Remove this para and add real priank pic. Present in
                                            assets team folder
                                        </p>
