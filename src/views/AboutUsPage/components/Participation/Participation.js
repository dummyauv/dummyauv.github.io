                ...
                <Container>
                    <Row className="d-flex justify-content-center">
                        ...
                        <Col xl="5" className="text-center">
                            ...
                            <img src={combinedimage} className="w-100 m-3 large-image-responsiveness" ></img>
                        ...
                        <Col xl="5" className="text-center">
                            ...
                            <img src={resimage} className="w-100 m-3 large-image-responsiveness" ></img>
                        ...
                        <Col xl="5" className="mt-5 text-center">
                            ...
                            <img src={trainimage} className=" w-100 m-3 large-image-responsiveness" ></img>
                        ...
                        <Col xl="5" className=" mt-5 text-center">
                            ...
                            <img src={csrimage} className="w-100 m-3 large-image-responsiveness"></img>
