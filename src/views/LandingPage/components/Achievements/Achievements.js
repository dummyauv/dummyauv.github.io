                   ...
                   <Container>
                    ...
                    <Row className="d-flex justify-content-center"> 
                        ...
                        <Col xl="6" lg="6"className="text-center u-margin-top-negative">
                            ...
                            <img src={paper} className="w-100 image-anahita mb-0"></img>
                        ...
                        <Col xl="6" lg="6" className="text-center u-margin-top-negative">
                            <h3 className="small-heading"></h3>
                            <img src={niot} className="border border-dark w-100 image-anahita responsive-achievement-image"></img>
                            ...
                            <h3 className="small-heading"></h3>
                            <img src={robosub} className="border border-dark w-100 image-anahita responsive-achievement-image responsive-achievement-image2 mb-5 mt-5"></img>
